...
export const getPackageInTransitEmailTemplate = (nombre, apellido, email, trackings, imagenes) => {
  ...
  const imageHtml = imageAttachments.map(img => `<img src="cid:${img.cid}" alt="Imagen del paquete" style="max-width: 200px; margin: 10px; border: 1px solid #e0e0e0; border-radius: 4px;">`).join('');
